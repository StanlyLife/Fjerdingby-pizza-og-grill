          ...
          <div className="row justify-content-between">
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              >
                ...
                <a href="https://g.co/kgs/JSRqE5f">
                  Øvre Rælingsveg 194, 2008 Fjerdingby
                </a>
              </div>
            </div>
            <div className="col-xl-2 col-lg-3 col-sm-6">
              ...
              >
                ...
                <ul>
                  <li>
                    <a href="mailto:wellfood@gmail.com">
                      <u>hei@Fjerdingbypizzagrill.no</u>
                    </a>
                  </li>
                  <li>
                    <a href="callto:+47 92 97 60 00">92 97 60 00</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-sm-6">
              ...
              >
                ...
                <ul>
                  <li>
                    ALLE DAGER <span>14:00 - 22:00</span>
                  </li>
                  {/* <li>
                    Saturday: <span>8am – 12am</span>
                  </li> */}
